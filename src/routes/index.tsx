...
const Header = memo(({ name, tagline }: { name: string; tagline: string }) => (
  <header className="bg-blue-900 text-white py-6">
    <div className="container mx-auto px-4">
      <HomeAnimatedElement as="h1" className="text-3xl font-bold">
        {name}
      </HomeAnimatedElement>
      <HomeAnimatedElement as="p" className="mt-2 text-lg">
        {tagline}
      </HomeAnimatedElement>
    </div>
  </header>
    ...
    <section className="bg-white py-12">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 mt-8 md:mt-0">
          <img src={heroImageUrl} alt={name} className="rounded-lg shadow-lg" />
        </div>
      </div>
    </section>
  )
...
const FeatureTeaser = memo(({ keyFeature }: { keyFeature: string }) => (
  <section className="py-12 bg-gray-50">
    <div className="container mx-auto px-4 text-center">
      ...
      <HomeAnimatedElement as="p" className="text-lg text-gray-600">
        {keyFeature}
      </HomeAnimatedElement>
      <Link
        to="/about"
  ...
  return (
    <div className="bg-gray-100 font-sans min-h-screen">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <HomeAnimatedElement as="h2" className="text-3xl font-bold text-gray-800 mb-4 text-center">
            About Robots
          </HomeAnimatedElement>
          <HomeAnimatedElement as="p" className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <HomeAnimatedElement as="h2" className="text-3xl font-bold text-gray-800 mb-4">
            How Robots Can Help Us
          </HomeAnimatedElement>
          <HomeAnimatedElement as="p" className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto mb-6">
